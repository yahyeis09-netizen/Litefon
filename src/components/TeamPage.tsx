      ...
      <main className="flex-grow relative flex flex-col overflow-hidden">
        ...
        <div className="relative z-10 flex-grow flex flex-col items-center justify-center text-center px-6 pt-24 pb-16">
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white dark:bg-zinc-800 shadow-sm mb-8"
          >
            <div className="w-1.5 h-1.5 rounded-full bg-primary-blue" />
            <span className="text-[10px] font-bold uppercase tracking-widest text-text-dark dark:text-zinc-100">Team Explore</span>
            <ChevronRight className="w-3 h-3 text-text-light dark:text-zinc-400" />
          </motion.div>
          ...
          <motion.h1
            ...
            className="text-3xl md:text-5xl font-bold tracking-tight text-text-dark dark:text-white mb-6 max-w-4xl mx-auto leading-[1.1]"
          >
            Explore Team
          </motion.h1>
          ...
          <motion.p
            ...
            className="text-lg text-text-light dark:text-zinc-400 mb-10 max-w-2xl mx-auto leading-relaxed"
          >
          ...
          >
            <button 
              ...
              className="px-10 py-4 rounded-full bg-primary-blue text-white text-base font-bold hover:bg-secondary-blue transition-colors shadow-xl shadow-primary-blue/20"
            >
              Create your team
            </button>
            <button 
              onClick={onContactClick}
              className="px-10 py-4 rounded-full bg-white dark:bg-zinc-800 text-text-dark dark:text-white border border-border-gray dark:border-zinc-700 text-base font-bold hover:bg-soft-gray dark:hover:bg-zinc-700 transition-colors"
            >
              See enterprise plan
            </button>
          </motion.div>
        ...
        <div className="relative z-10 w-full pb-32 overflow-visible">
            ...
            {countries.map((country, index) => {
              ...
              return (
                <motion.div
                  ...
                  className="relative flex-shrink-0 w-48 h-72 md:w-64 md:h-96 rounded-3xl overflow-hidden cursor-pointer shadow-2xl group"
                >
                  {/* Background Flag */}
                  <img 
                    src={country.flag} 
