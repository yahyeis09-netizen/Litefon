      ...
      <main className="flex-grow pt-24 pb-16 px-6">
        ...
        <header className="max-w-4xl mx-auto text-center mb-16">
          ...
          <motion.h1
            ...
            className="text-4xl md:text-6xl font-bold text-text-dark dark:text-white mb-8 leading-[1.15] max-w-3xl mx-auto"
          >
          ...
          <motion.div
            ...
            className="flex items-center justify-center gap-4 text-sm text-text-light dark:text-zinc-400"
          >
            <div className="flex items-center gap-2">
              <img 
                src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?auto=format&fit=facearea&facepad=2&w=48&h=48&q=80" 
                alt="Author" 
                className="w-8 h-8 rounded-full border border-border-gray dark:border-zinc-700"
              />
              <span className="font-medium text-text-dark dark:text-zinc-200">Alex Thompson</span>
            </div>
            <span>•</span>
        ...
        <div className="max-w-6xl mx-auto relative">
          ...
          <aside className="hidden lg:flex flex-col gap-4 absolute left-0 top-0 sticky top-40 h-fit -translate-x-24">
            {[Twitter, Linkedin, Facebook, LinkIcon].map((Icon, i) => (
              <button 
                key={i}
                className="w-10 h-10 rounded-full border border-border-gray dark:border-zinc-700 flex items-center justify-center text-text-light dark:text-zinc-400 hover:text-primary-blue hover:border-primary-blue transition-all bg-white dark:bg-zinc-800 shadow-sm"
              >
          ...
          <article className="max-w-[740px] mx-auto">
            <div className="prose prose-lg prose-slate dark:prose-invert max-w-none">
              <p className="text-xl text-text-light dark:text-zinc-300 leading-relaxed mb-8">
              ...
              <div className="mt-24 p-12 rounded-[2.5rem] bg-soft-gray dark:bg-zinc-800 border border-border-gray dark:border-zinc-700 text-center relative overflow-hidden">
                <div className="absolute top-0 right-0 w-32 h-32 bg-primary-blue/5 rounded-full translate-x-1/2 -translate-y-1/2" />
                
                <h3 className="text-3xl font-bold text-text-dark dark:text-white mb-4 relative z-10">Ready to switch?</h3>
                <p className="text-lg text-text-light dark:text-zinc-400 mb-10 max-w-md mx-auto relative z-10">
